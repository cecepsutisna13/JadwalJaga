							    ...
							    <div class="modal-content">
								      ...
								      <div class="modal-body">
							                <div class="form-group">
							                  <label>Nama</label>
							                  <input type="text" class="form-control" name="add_nama" placeholder="Nama Lengkap">
							                </div>
							                <div class="form-group">
							                  <label>Email</label>
							                ...
							                <div class="form-group">
							                  <label>Peran</label>
							                  <input type="text" class="form-control" name="add_peran" placeholder="Peran">
							                </div>
											<div class="form-group">
							                  <label>Status</label>
							    ...
							    <div class="modal-content">
								      ...
								      <div class="modal-body">
							                <div class="form-group">
							                  ...
							                  <input type="text" class="form-control" name="update_nama" placeholder="Nama Lengkap">
							                </div>
							                <div class="form-group">
							                  <label>Email</label>
							                ...
							                <div class="form-group">
							                  <label>Peran</label>
							                  <input type="text" class="form-control" name="update_peran" placeholder="Peran">
							                </div>
											<div class="form-group">
							                  <label>Status</label>
				...
				$.ajax({
				    ...
				    success:function(data){
				        $("input[name=\"update_id\"]").val(data[0].id);
			  			...
			  			$("input[name=\"update_peran\"]").val(data[0].Peran);
			...
			function refresh_tabel(){
		  	...
		  	$(document).ready(function(){
			  	...
			  	$("#add_action").click(function(){
			  		...
			  		var Peran = $("input[name=\"add_peran\"]").val();
			  	...
			  	$("#update_action").click(function(){
			  		...
			  		var Peran = $("input[name=\"update_peran\"]").val();
